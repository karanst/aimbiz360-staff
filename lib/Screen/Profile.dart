  ...
  Future<void> updateUser() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        request.fields['username'] = name.toString();
        request.fields[Email] = email.toString();
        if(_profileImage != null) {
          var pic = await http.MultipartFile.fromPath('image', _profileImage!.path);
          request.files.add(pic);
        }
        print("this is update profile request ------->>> ${request.fields.toString()}");

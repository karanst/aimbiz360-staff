...
//========================= All API's here =====================================
///NEW APIS///////
final Uri staffLogin = Uri.parse(baseUrl + 'staff_login');
final Uri leadsApi = Uri.parse(baseUrl + 'leads');
final Uri updateLeadStatusApi = Uri.parse(baseUrl + 'update_leads_status');
final Uri allUsersApi = Uri.parse(baseUrl + 'user_list');
///NEW APIS///////
